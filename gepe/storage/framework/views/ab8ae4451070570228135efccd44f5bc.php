...
<body>
    ...
    <table>
        <tr>
            <td><a href="<?php echo e(route('character.list')); ?>">Lista de Personagens</a></td>
        </tr>
        <tr>
            <td><a href="<?php echo e(route('race.list')); ?>">Lista de Ascendências</a></td>
        </tr>
        <tr>
            <td><a href="<?php echo e(route('profession.list')); ?>">Lista de Profissões</a></td>
        </tr>
        <tr>
            <td><a href="<?php echo e(route('player.list')); ?>">Lista de Jogadores</a></td>
        </tr>
    </table>
</body>

</html>
<?php /**PATH C:\laragon\www\gepe\resources\views/index.blade.php ENDPATH**/ ?>